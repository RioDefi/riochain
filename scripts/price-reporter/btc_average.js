...
async function getPrices() {
    ...
    if (!fetchingPrice) {
        console.log('ready to fetch prices', Object.keys(exchanges));
        fetchingPrice = true;
        price = {};
        for (let item in exchanges) {
            ...
            try {
                ...
                if (currentTicker.last < config.maxPrice && currentTicker.last > config.minPrice) {
