...
export-beta:
	./target/release/riodefi build-spec --chain beta > chainspec_beta.json

export-local:
	./target/release/riodefi build-spec --chain local > chainspec_local.json

export-beta-raw:
	./target/release/riodefi build-spec --chain ./chainspec_beta.json --raw > chainspec_beta_raw.json

export-local-raw:
	./target/release/riodefi build-spec --chain ./chainspec_local --raw > chainspec_local_raw.json
